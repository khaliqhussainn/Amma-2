 ...
 * Generates a premium HTML email for registration OTP verification.
 *
 * @param {string} otp - The 6-digit OTP code to embed in the email.
 * @returns {string} Full HTML string for the verification email.
 */
    ...
    <tr>
      <td align="center">
        ...
        <table width="600" cellpadding="0" cellspacing="0" border="0"
          ...
          <!-- Header bar -->
          <tr>
            <td style="background:linear-gradient(135deg,#042C53 0%,#0a4a8a 100%);padding:36px 40px;text-align:center;">
          ...
          <tr>
            <td style="padding:44px 48px 36px;">
              ...
              <p style="margin:0 0 8px;font-size:16px;color:#374151;line-height:1.6;">
                Thank you for registering with <strong>AMMA National</strong>.
              </p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top:32px;">
                <tr>
                  <td style="padding:12px 16px;background:#f9fafb;border-radius:8px;border-left:4px solid #042C53;">
                    <p style="margin:0;font-size:13px;color:#374151;line-height:1.5;">
                      ⏱️ &nbsp;<strong>Expires in 10 minutes.</strong> Enter it promptly.
                    </p>
                  </td>
                </tr>
                ...
                <tr><td style="height:10px;"></td></tr>
                <tr>
                  <td style="padding:12px 16px;background:#f9fafb;border-radius:8px;border-left:4px solid #9ca3af;">
                    <p style="margin:0;font-size:13px;color:#374151;line-height:1.5;">
                      ℹ️ &nbsp;If you did not create an account, you can safely ignore this email.
                    </p>
                  </td>
                </tr>
              </table>
